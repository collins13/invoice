          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-5 d-none d-lg-block ">
                  <img src="/img/icon_image.png" alt="">
              </div>
              <div class="col-lg-7">
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input id="password-confirm" type="password" class="form-control form-control-user" name="password_confirmation" required autocomplete="new-password" placeholder="Conferm password">
                            </div>
                        </div>
