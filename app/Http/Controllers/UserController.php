...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $user = User::create(['name' => $request->name, 'email' => $request->email, 'password' => Hash::make($password)]); //Create User table entry

            foreach ($request->input('roles') as $key => $value) {
                $user->attachRole($value);
                //   Mail::to($users->email)->send(new Users($users));
            }
